...
const achievements = [
  ...
  },
  {
    ...
    title: "Smart Photo Gallery — Production Deployment",
    desc: "Shipped a live full-stack platform with Google OAuth 2.0, dual authentication, and automated email recovery — independently debugged spam-filter, timezone, and HTTPS redirect issues in production.",
    year: "2026",
  },
  {
    icon: <Zap size={22} />,
